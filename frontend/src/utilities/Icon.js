...
export default ({name, tailwindClass=''})=>{
    switch(name){
        case 'bars':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 448 512"><path className={tailwindClass} d="M16 132h416c8.837 0 16-7.163 16-16V76c0-8.837-7.163-16-16-16H16C7.163 60 0 67.163 0 76v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16zm0 160h416c8.837 0 16-7.163 16-16v-40c0-8.837-7.163-16-16-16H16c-8.837 0-16 7.163-16 16v40c0 8.837 7.163 16 16 16z"></path></svg>
        break;
        case 'facebook':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 512 512"><path className={tailwindClass} d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48c27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"></path></svg>
        break;
        case 'youtube':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 576 512"><path className={tailwindClass} d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597c-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821c11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205l-142.739 81.201z"></path></svg>
        break;
        case 'twitter':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 512 512"><path className={tailwindClass} d="M459.37 151.716c.325 4.548.325 9.097.325 13.645c0 138.72-105.583 298.558-298.558 298.558c-59.452 0-114.68-17.219-161.137-47.106c8.447.974 16.568 1.299 25.34 1.299c49.055 0 94.213-16.568 130.274-44.832c-46.132-.975-84.792-31.188-98.112-72.772c6.498.974 12.995 1.624 19.818 1.624c9.421 0 18.843-1.3 27.614-3.573c-48.081-9.747-84.143-51.98-84.143-102.985v-1.299c13.969 7.797 30.214 12.67 47.431 13.319c-28.264-18.843-46.781-51.005-46.781-87.391c0-19.492 5.197-37.36 14.294-52.954c51.655 63.675 129.3 105.258 216.365 109.807c-1.624-7.797-2.599-15.918-2.599-24.04c0-57.828 46.782-104.934 104.934-104.934c30.213 0 57.502 12.67 76.67 33.137c23.715-4.548 46.456-13.32 66.599-25.34c-7.798 24.366-24.366 44.833-46.132 57.827c21.117-2.273 41.584-8.122 60.426-16.243c-14.292 20.791-32.161 39.308-52.628 54.253z"></path></svg>
        break;
        case 'instagram':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 448 512"><path className={tailwindClass} d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9S287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7s74.7 33.5 74.7 74.7s-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8c-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8s26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9c-26.2-26.2-58-34.4-93.9-36.2c-37-2.1-147.9-2.1-184.9 0c-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9c1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0c35.9-1.7 67.7-9.9 93.9-36.2c26.2-26.2 34.4-58 36.2-93.9c2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6c-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6c-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6c29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6c11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"></path></svg>
        break;
        case 'bulb':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path fill="none" className={tailwindClass} stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 1 1 7.072 0l-.548.547A3.374 3.374 0 0 0 14 18.469V19a2 2 0 1 1-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547Z"></path></svg>
        break;
        case 'filter':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M3 4c2.01 2.59 7 9 7 9v7h4v-7s4.98-6.41 7-9H3z"></path></svg>
        break;
        case 'list_view':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M3 21v-8h18v8Zm0-10V3h18v8Z"></path></svg>
        break;
        case 'window_view':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M3 11V3h8v8Zm0 10v-8h8v8Zm10-10V3h8v8Zm0 10v-8h8v8Z"></path></svg>
        break;
        case 'cart':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M7 22q-.825 0-1.412-.587Q5 20.825 5 20q0-.825.588-1.413Q6.175 18 7 18t1.412.587Q9 19.175 9 20q0 .825-.588 1.413Q7.825 22 7 22Zm10 0q-.825 0-1.412-.587Q15 20.825 15 20q0-.825.588-1.413Q16.175 18 17 18t1.413.587Q19 19.175 19 20q0 .825-.587 1.413Q17.825 22 17 22ZM6.15 6l2.4 5h7l2.75-5ZM3.625 17L6.6 11.6L3 4H1V2h3.25l.95 2h16.5l-4.975 9H8.1L7 15h12v2Zm4.925-6h7Z"></path></svg>
        break;
        case 'play':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M9.5 9.325v5.35q0 .575.525.875q.525.3 1.025-.05l4.15-2.65q.475-.3.475-.85t-.475-.85L11.05 8.5q-.5-.35-1.025-.05q-.525.3-.525.875ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"></path></svg>
        break;
        case 'home':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M10 19v-5h4v5c0 .55.45 1 1 1h3c.55 0 1-.45 1-1v-7h1.7c.46 0 .68-.57.33-.87L12.67 3.6c-.38-.34-.96-.34-1.34 0l-8.36 7.53c-.34.3-.13.87.33.87H5v7c0 .55.45 1 1 1h3c.55 0 1-.45 1-1z"></path></svg>
        break;
        case 'cash_on_delivery':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M18.5 16.8c-.7 0-1.2-.6-1.2-1.2c0-.7.6-1.2 1.2-1.2s1.2.6 1.2 1.2c.1.6-.5 1.2-1.2 1.2m0-4.8c-1.9 0-3.5 1.6-3.5 3.5c0 2.6 3.5 6.5 3.5 6.5s3.5-3.9 3.5-6.5c0-1.9-1.6-3.5-3.5-3.5m-3.6-.7C14.6 10 13.4 9 12 9c-1.7 0-3 1.3-3 3s1.3 3 3 3c.4 0 .7-.1 1-.2c.2-1.4.9-2.6 1.9-3.5M13 16H7a2 2 0 0 0-2-2v-4a2 2 0 0 0 2-2h10a2 2 0 0 0 2 2s1 0 2 .6V6H3v12h10.5c-.2-.7-.4-1.3-.5-2Z"></path></svg>
        break;
        case 'wallet':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M10 16V8a2 2 0 0 1 2-2h9V5c0-1.1-.9-2-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-1h-9a2 2 0 0 1-2-2zm3-8c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h9V8h-9zm3 5.5c-.83 0-1.5-.67-1.5-1.5s.67-1.5 1.5-1.5s1.5.67 1.5 1.5s-.67 1.5-1.5 1.5z"></path></svg>
        break;
        case 'paypal':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M9.93 12.99c.1 0 2.42.1 3.8-.24h.01c1.59-.39 3.8-1.51 4.37-5.17c0 0 1.27-4.58-5.03-4.58H7.67c-.49 0-.91.36-.99.84L4.38 18.4c-.05.3.19.58.49.58H8.3l.84-5.32c.06-.38.39-.67.79-.67z"></path><path fill="currentColor" d="M18.99 8.29c-.81 3.73-3.36 5.7-7.42 5.7H10.1l-1.03 6.52c-.04.26.16.49.42.49h1.9c.34 0 .64-.25.69-.59c.08-.4.52-3.32.61-3.82c.05-.34.35-.59.69-.59h.44c2.82 0 5.03-1.15 5.68-4.46c.26-1.34.12-2.44-.51-3.25z"></path></svg>
        case 'credit_card':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M4 20q-.825 0-1.412-.587Q2 18.825 2 18V6q0-.825.588-1.412Q3.175 4 4 4h16q.825 0 1.413.588Q22 5.175 22 6v12q0 .825-.587 1.413Q20.825 20 20 20Zm0-8h16V8H4Z"></path></svg>
        break;
        case 'edit':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M5 23.7q-.825 0-1.413-.588Q3 22.525 3 21.7v-14q0-.825.587-1.413Q4.175 5.7 5 5.7h8.925L7 12.625V19.7h7.075L21 12.75v8.95q0 .825-.587 1.412q-.588.588-1.413.588Zm4-6v-4.25l7.175-7.175l4.275 4.2l-7.2 7.225Zm12.875-8.65L17.6 4.85l1.075-1.075q.6-.6 1.438-.6q.837 0 1.412.6l1.4 1.425q.575.575.575 1.4T22.925 8Z"></path></svg>
        break;
        case 'delivery':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M3 4a2 2 0 0 0-2 2v11h2a3 3 0 0 0 3 3a3 3 0 0 0 3-3h6a3 3 0 0 0 3 3a3 3 0 0 0 3-3h2v-5l-3-4h-3V4m-7 2l4 4l-4 4v-3H4V9h6m7 .5h2.5l1.97 2.5H17M6 15.5A1.5 1.5 0 0 1 7.5 17A1.5 1.5 0 0 1 6 18.5A1.5 1.5 0 0 1 4.5 17A1.5 1.5 0 0 1 6 15.5m12 0a1.5 1.5 0 0 1 1.5 1.5a1.5 1.5 0 0 1-1.5 1.5a1.5 1.5 0 0 1-1.5-1.5a1.5 1.5 0 0 1 1.5-1.5Z"></path></svg>
        break;
        case 'person':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M12 12q-1.65 0-2.825-1.175T8 8q0-1.65 1.175-2.825T12 4q1.65 0 2.825 1.175T16 8q0 1.65-1.175 2.825T12 12Zm-8 8v-2.8q0-.85.438-1.563T5.6 14.55q1.55-.775 3.15-1.163T12 13q1.65 0 3.25.388t3.15 1.162q.725.375 1.163 1.088T20 17.2V20H4Z"></path></svg>
        break;
        case 'search':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="m18.9 20.3l-5.6-5.6q-.75.6-1.725.95T9.5 16q-2.725 0-4.612-1.888T3 9.5q0-2.725 1.888-4.612T9.5 3q2.725 0 4.612 1.888T16 9.5q0 1.1-.35 2.075T14.7 13.3l5.625 5.625q.275.275.275.675t-.3.7q-.275.275-.7.275t-.7-.275ZM9.5 14q1.875 0 3.188-1.313T14 9.5q0-1.875-1.313-3.188T9.5 5Q7.625 5 6.312 6.313T5 9.5q0 1.875 1.313 3.188T9.5 14Z"></path></svg>
        break;
        case 'down':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="m12 15l-5-5h10Z"></path></svg>
        break;
        case 'remove':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M5 13v-2h14v2Z"></path></svg>
        break;
        case 'up':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="m7 14l5-5l5 5Z"></path></svg>
        break;
        case 'check':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="m9.55 18l-5.7-5.7l1.425-1.425L9.55 15.15l9.175-9.175L20.15 7.4Z"></path></svg>
        break;
        case 'location':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M12 12q.825 0 1.413-.588Q14 10.825 14 10t-.587-1.413Q12.825 8 12 8q-.825 0-1.412.587Q10 9.175 10 10q0 .825.588 1.412Q11.175 12 12 12Zm0 9.625q-.2 0-.4-.075t-.35-.2Q7.6 18.125 5.8 15.363Q4 12.6 4 10.2q0-3.75 2.413-5.975Q8.825 2 12 2t5.587 2.225Q20 6.45 20 10.2q0 2.4-1.8 5.163q-1.8 2.762-5.45 5.987q-.15.125-.35.2q-.2.075-.4.075Z"></path></svg>
        break;
        case 'close':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M6.4 19L5 17.6l5.6-5.6L5 6.4L6.4 5l5.6 5.6L17.6 5L19 6.4L13.4 12l5.6 5.6l-1.4 1.4l-5.6-5.6L6.4 19Z"></path></svg>
        break;
        case 'first_page':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M6 18V6h2v12Zm11 0l-6-6l6-6l1.4 1.4l-4.6 4.6l4.6 4.6Z"></path></svg>
        break;
        case '5_star':
        ...
        break;
        case 'bookmark':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M5 21V5q0-.825.588-1.413Q6.175 3 7 3h6v2H7v12.95l5-2.15l5 2.15V11h2v10l-7-3ZM7 5h6h-1Zm10 4V7h-2V5h2V3h2v2h2v2h-2v2Z"></path></svg>
            break;
        case 'share':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M18 22q-1.25 0-2.125-.875T15 19q0-.175.025-.363q.025-.187.075-.337l-7.05-4.1q-.425.375-.95.587Q6.575 15 6 15q-1.25 0-2.125-.875T3 12q0-1.25.875-2.125T6 9q.575 0 1.1.212q.525.213.95.588l7.05-4.1q-.05-.15-.075-.337Q15 5.175 15 5q0-1.25.875-2.125T18 2q1.25 0 2.125.875T21 5q0 1.25-.875 2.125T18 8q-.575 0-1.1-.213q-.525-.212-.95-.587L8.9 11.3q.05.15.075.337Q9 11.825 9 12t-.025.362q-.025.188-.075.338l7.05 4.1q.425-.375.95-.588Q17.425 16 18 16q1.25 0 2.125.875T21 19q0 1.25-.875 2.125T18 22Z"></path></svg>
            break;
        case 'rounded_check':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="m10.6 16.6l7.05-7.05l-1.4-1.4l-5.65 5.65l-2.85-2.85l-1.4 1.4ZM12 22q-2.075 0-3.9-.788q-1.825-.787-3.175-2.137q-1.35-1.35-2.137-3.175Q2 14.075 2 12t.788-3.9q.787-1.825 2.137-3.175q1.35-1.35 3.175-2.138Q9.925 2 12 2t3.9.787q1.825.788 3.175 2.138q1.35 1.35 2.137 3.175Q22 9.925 22 12t-.788 3.9q-.787 1.825-2.137 3.175q-1.35 1.35-3.175 2.137Q14.075 22 12 22Z"></path></svg>
        break;
        case 'eye':
            return <svg xmlns="http://www.w3.org/2000/svg" width={`100%`} height={`100%`} viewBox="0 0 24 24"><path className={tailwindClass} d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5s5 2.24 5 5s-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3s3-1.34 3-3s-1.34-3-3-3z"></path></svg>
        break;
        case 'donut1':
        ...
        case 'musifier_dark':
            ...
            <div style={{height:'100%', width:'100%', position:'relative'}}>
                <Image src="/logo/Musifier_Logo_Dark.svg" alt="musifier_dark" layout='fill'/>
            </div>
            </>
        break;
        default:
