...
export default () => {
    ...
    return <>
    <footer className="w-full flex justify-center sm:px-10 px-5 pt-10 pb-8 bg-gray-900 text-slate-300">
        <main className="w-[70rem] flex flex-wrap gap-10">
            <section className="flex-1 flex sm:flex-nowrap flex-wrap gap-x-10 mb-5">
                <div className="flex-0 sm:w-auto w-full flex justify-center">
                ...
                <div className="flex-1 sm:pt-0 pt-5">
                    <h1 className="text-2xl font-semibold tracking-tighter pb-5 sm:text-left text-center">Creator</h1>
            ...
            <section className="flex-0 md:w-3/12 w-full">
                ...
                <div className="w-ful flex flex-wrap gap-5 md:justify-start justify-center">
                    ...
                    <div className="w-8 h-8 p-1 rounded-lg bg-slate-300 cursor-pointer" onClick={()=>{window.open('https://www.twitter.com/Mekani_Tekno', '_blank');}}>
                        <Icon name="twitter" tailwindClass="fill-gray-900" />
                    </div>
                    <div className="w-8 h-8 p-1 rounded-lg bg-slate-300 cursor-pointer flex items-center" onClick={()=>{window.open('https://www.youtube.com/@mekani_tekno', '_blank');}}>
                        <Icon name="youtube" tailwindClass="fill-gray-900" />
                    </div>
                </div>
            </section>
